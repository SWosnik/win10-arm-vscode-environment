...
if DEFINED NOT_HAVE_VSCODE set CALL_INSTALL_BAT=1
if DEFINED NOT_HAVE_GCC    set CALL_INSTALL_BAT=1
if DEFINED NOT_HAVE_MAKE   set CALL_INSTALL_BAT=1
if DEFINED NOT_HAVE_UTILS  set CALL_INSTALL_BAT=1
if DEFINED NOT_HAVE_GIT    set CALL_INSTALL_BAT=1
